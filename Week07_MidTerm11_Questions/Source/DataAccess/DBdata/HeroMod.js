 ...
 * @author MIKE
 */
//Charlie--- More explanation. Does this return "heros" or "Heros"
//In the debugger break point at 'return Heros' it never gets executed
...
.factory('heros', function($resource) {
    ...
    Heros.prototype.getHeroHitPoints = function() {
    	return this.hitPoints;
    };
    
    Heros.prototype.getHeroDamage = function() {
    	return this.damage;
    };
